...
public class OpenTextMailClient
{
	private static String OT_SMTP_HOST = "webmail-ph.opentext.com"; //outlook.office365.com

	private static String OT_SMTP_PORT = "587";
	...
	private static String NO_REPLY = "Automated_BuildStreet_Report";
